<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Fish.aspx.cs" Inherits="OnlineBazar.Fish" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 align="center" class="par" >Fish Category</h1>
    <br />
    <br />
    <asp:DataList ID="DataList1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource1" GridLines="Both" HorizontalAlign="Center" RepeatColumns="4" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand">
        ...
        <ItemTemplate>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="txt-center">
                        <asp:ImageButton ID="ImageButton1" runat="server" Height="47px" ImageUrl="~/admin/ProductImages/cart.png" Width="47px" CommandName="productDetails" CommandArgument='<%# Eval("prodID") %>' />
                    </td>
                </tr>
            </table>
        </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:onlineBazarConnectionString2 %>" SelectCommand="SELECT * FROM [Allproduct] WHERE ([category] = @category)">
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="Fish" Name="category" QueryStringField="category" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
